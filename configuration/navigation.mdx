...
<Steps>
  <Step title="Create the file" icon="default">
    Add a new `.mdx` file at the path you want. Use folders to nest pages under
    a path.
  </Step>

  <Step title="List it in docs.json" icon="default">
...
<Columns cols="2">
  <Card title="Theme" href="/configuration/theme" cta="" icon="palette" iconColor="gray" />
